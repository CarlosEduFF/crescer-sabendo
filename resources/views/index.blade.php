...
<body class="bg-gray-100 overflow-x-hidden">
    ...
    <div id="home" class="relative w-screen h-100 mb-4 md:mb-10 -z-40">
        ...
        <div id="overlay" class="mr-3 absolute md:left-36 md:top-32 flex items-center justify-center p-4">
            <div id="divContent" class="bg-white  rounded-3xl shadow-2xl p-14 max-w-lg text-center">
                ...
                <p class="text-gray-700 text-xl font-itim">Apoiamos ONGs dedicadas a oferecer atividades
                    extracurriculares que estimulam a criatividade e promovem o conhecimento.</p>
            </div>
        </div>
    ...
    <div class="flex justify-center items-center">
        <div id="gridIcons" class="grid gap-12 sm:grid-cols-1 md:grid-cols-3">
            <div class="relative bg-white mt-10 p-4 shadow-2xl flex flex-col items-center w-100 md:w-120 h-96 md:h-96">
                <img src="{{ asset('images/icons/iconTargetShooting.png') }}" alt="Icon 1"
                    class="h-16 md:h-20 absolute md:-top-12 -top-10">
                <h2 class="text-2xl font-bold mt-10 text-purple-800">Missão</h2>
                <p class="mt-2 text-center">Nossa missão é proporcionar uma plataforma intuitiva e eficiente para que
                    ONGs sem presença online possam divulgar seus trabalhos de maneira rápida e prática.</p>
            </div>
            <div class="relative bg-white mt-10 p-4 shadow-2xl flex flex-col items-center w-100 md:w-120 h-96 md:h-96">
                <img src="{{ asset('images/icons/lineG.png') }}" alt="Icon 2"
                    class="h-14 md:h-20 absolute -top-8 md:-top-12">
                <h2 class="text-2xl font-bold mt-10 text-purple-800">Visão</h2>
                <p class="mt-2 text-center">Visamos apoiar o maior número possível de ONGs, possibilitando que
                    contribuam para o avanço do conhecimento através dos sues cursos oferecidos em nossa plataforma,
                    promovendo um impacto positivo na sociedade.</p>
            </div>
            <div class="relative bg-white mt-10 p-4 shadow-2xl flex flex-col items-center w-100 md:w-120 h-96 md:h-96">
                <img src="{{ asset('images/icons/loveHand.png') }}" alt="Icon 3"
                    class="h-16 md:h-20 absolute md:-top-14 -top-12">
                <h2 class="text-2xl font-bold mt-10 text-purple-800">Valores</h2>
                <p class="mt-2 text-center">Valorizamos a acessibilidade, a colaboração e o compromisso com o
                    desenvolvimento social, oferecendo ferramentas eficazes para ampliar o alcance e a eficácia das
                    iniciativas das ONGs em nossa comunidade global.</p>
            </div>
        </div>
    </div>
    <!-- End Icons Cards -->
        ...
        <div>
            <div class="relative w-screen">
                ...
                <div id="text-container"
                    class="absolute inset-0 flex flex-col items-start  md:ml-28 justify-center  p-6">
                    <p id="textP" class="text-base md:text-4xl font-itim">Descubra as organizações incríveis que já
                        fazem parte da nossa plataforma, <br> além dos cursos incríveis que elas oferecem gratuitamente.
                        <br><br> Você também pode contribuir! <br> Escolha uma das ONGs abaixo para acessar seu perfil e
                        encontrar informações sobre como ajudar por meio de doações ou divulgando suas ações sociais..
                    </p>
                </div>
            </div>
        </div>
    ...
    <div id="dadosContainer" class="relative p-8 bg-white shadow-2xl rounded-lg mx-auto mt-20 mb-20  w-container h-100">
        <div id="quebracabeca" class="absolute -z-50 top-10 left-0 transform -translate-x-44 -translate-y-2">
            <img id="quebraCabecaImage" class="hidden md:block h-64" src="{{ asset('images/quebra-cabeca.png') }}"
                alt="">
        </div>
        ...
        <div class="md:mt-36 mt-24 grid grid-cols-3 gap-16 place-items-center">
            <div class="text-center">
                <svg class="w-12 h-12 mx-auto" fill="black" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M7 8h10v1H7V8zm0 3h8v1H7v-1zm-5 2a2 2 0 01-2-2V4a2 2 0 012-2h18a2 2 0 012 2v7a2 2 0 01-2 2H2zm18 1v1a2 2 0 01-2 2h-1v2a2 2 0 01-2 2H7a2 2 0 01-2-2v-2H4a2 2 0 01-2-2v-1h18z" />
                </svg>
        ...
        <div class="flex justify-center ">
            <button class="py-3 px-5 bg-purple-700 rounded-lg text-white font-bold mt-16 md:mt-20 text-xl"><a
                    href="/signup">Criar Minha Conta</a></button>
        </div>
            ...
            <div class="flex flex-col space-y-6 flex-grow">
                <form action="">
                    <label class="block">
                        ...
                        <input type="text"
                            class="mt-1 block w-full border-4 border-customPurple rounded-full px-6 py-3">
                    </label>
                    <label class="block">
                    ...
                    <label class="block">
                        ...
                        <textarea
                            class="mt-1 block w-full border-4 border-customPurple  rounded-xl px-6 py-3"></textarea>
                    </label>
                    <button
                        class="bg-customPurple text-white font-itim rounded-full px-6 py-3 mt-4 self-start hover:bg-purple-900">Enviar</button>
            </div>
            ...
            <div class="flex flex-col flex-grow">
                ...
                <div class="mt-4">
                    <iframe
                        ...
                        width="100%" height="285" style="border:0;" allowfullscreen="" aria-hidden="false"
                        tabindex="0"></iframe>
                </div>
                </form>
            </div>
